...
const url = "mongodb+srv://"+mongo_user+":"+mongo_password+"@"+mongo_url+"/projectsdatabase?retryWrites=true&w=majority"
...
app.use("/api",isUserLogged, projectsroute);
app.use("/api",isUserLogged,wikiroute);
